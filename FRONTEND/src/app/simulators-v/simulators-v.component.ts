...
export class SimulatorsVComponent implements OnInit {
  ...
  new() {
    ...
    // });
     hbspt.forms.create({
       portalId: '6606991',
       formId: 'a8ddb3bd-abf5-43d5-86ab-9bc071e7e0f5',
       region: 'na1',
       target: '#hubspotForm',
     });
     window.scrollTo(0, 0);
    ...
    if (this.itemS == 0 && this.francesa.is_visible) {
      let docDefinition = {
        ...
        content: [
          ...
          // { text: 'Tu hogar, tu mayor inversión', color: '#DA2128', bold: true, fontSize: 16, margin: [0, 0, 0, 10] },
          // { text: 'Adquirir tu vivienda es una de las decisiones financieras más importantes de tu vida. En Banco ProCredit, te acompañamos con transparencia y compromiso en cada paso del camino.', fontSize: 11, color: '#1a1a1a', margin: [0, 0, 0, 6] },
          // { text: 'Esta simulación presenta los detalles de tu crédito hipotecario, incluyendo la tabla de amortización con el desglose de capital, intereses y seguro en cada periodo.', fontSize: 11, color: '#1a1a1a', margin: [0, 0, 0, 16] },
          {
            columns: [
              {
                table: {
          ...
          // { text: 'Porque tu hogar es el lugar donde comienza tu historia.', italics: true, alignment: 'center', fontSize: 11, margin: [0, 24, 0, 0] },
        ],
        styles: {
          table: {
            bold: true,
    ...
    if (this.itemS == 0 && this.francesa.is_visible) {
      let docDefinition = {
        ...
        content: [
          ...
          // { text: 'Your home, your greatest investment', color: '#DA2128', bold: true, fontSize: 16, margin: [0, 0, 0, 10] },
          // { text: 'Buying your home is one of the most important financial decisions of your life. At Banco ProCredit, we accompany you with transparency and commitment every step of the way.', fontSize: 11, color: '#1a1a1a', margin: [0, 0, 0, 6] },
          // { text: 'This simulation presents the details of your mortgage loan, including the amortization table with a breakdown of principal, interest, and insurance for each period.', fontSize: 11, color: '#1a1a1a', margin: [0, 0, 0, 16] },
          {
            columns: [
              {
                table: {
                  ...
                  body: [
                    [
                      {
                        text: 'Housing Loan — French Payment Schedule',
                        alignment: 'center',
                        fillColor: '#DA2128',
                        color: 'white',
                        bold: true,
          ...
          // { text: 'Because your home is where your story begins.', italics: true, alignment: 'center', fontSize: 11, margin: [0, 24, 0, 0] },
        ],
        styles: {
          table: {
            bold: true,
            ...
            columns: [
              {
                table: {
                  ...
                  body: [
                    [
                      {
                        text: 'Housing Loan — German Payment Schedule',
                        alignment: 'center',
                        fillColor: '#DA2128',
                        color: 'white',
                        bold: true,
