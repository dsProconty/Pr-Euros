...
export class SimulatorsIpComponent implements OnInit {
  ...
  simuladorInversion(): void {
    ...
    if (
      ...
      this.porcentajeSeguroDesgravamen = 0.10 / 100;
    ...
    if (this.itemS == 0 && this.francesa.is_visible) {
      let docDefinition = {
        ...
        content: [
          ...
          { text: 'Tu inversión, con respaldo y libertad', color: '#DA2128', bold: true, fontSize: 16, margin: [0, 0, 0, 10] },
          { text: 'Este es el primer paso para tomar decisiones financieras informadas y responsables. En Banco ProCredit, creemos que la verdadera libertad comienza cuando entiendes y controlas tus finanzas.', fontSize: 11, color: '#1a1a1a', margin: [0, 0, 0, 6] },
          { text: 'Esta simulación presenta los detalles de tu crédito, incluyendo la tabla de amortización con el desglose de capital, intereses y seguro en cada periodo.', fontSize: 11, color: '#1a1a1a', margin: [0, 0, 0, 16] },
          {
            columns: [
              {
                table: {
                  ...
                  body: [
                    [
                      {
                        text: `${this.nombreProducto} — Amortización Francesa`,
                        alignment: 'center',
                        fillColor: '#DA2128',
                        color: 'white',
                        bold: true,
          ...
          // { text: 'Porque cuando inviertes con conocimiento, construyes el futuro que mereces.', italics: true, alignment: 'center', fontSize: 11, margin: [0, 24, 0, 0] },
        ],
        styles: {
          table: {
            bold: true,
            ...
            columns: [
              {
                table: {
                  ...
                  body: [
                    [
                      {
                        text: `${this.nombreProducto} — Amortización Alemana`,
                        alignment: 'center',
                        fillColor: '#DA2128',
                        color: 'white',
                        bold: true,
    ...
    if (this.itemS == 0 && this.francesa.is_visible) {
      let docDefinition = {
        ...
        content: [
          ...
          { text: 'Your investment, backed and free', color: '#DA2128', bold: true, fontSize: 16, margin: [0, 0, 0, 10] },
          { text: 'This is your first step toward making informed and responsible financial decisions. At Banco ProCredit, we believe true freedom begins when you understand and control your finances.', fontSize: 11, color: '#1a1a1a', margin: [0, 0, 0, 6] },
          { text: 'This simulation presents the details of your loan, including the amortization table with a breakdown of principal, interest, and insurance for each period.', fontSize: 11, color: '#1a1a1a', margin: [0, 0, 0, 16] },
          {
            columns: [
              {
                table: {
                  ...
                  body: [
                    [
                      {
                        text: 'Personal Investment Credit — French Payment Schedule',
                        alignment: 'center',
                        fillColor: '#DA2128',
                        color: 'white',
                        bold: true,
          ...
          // { text: 'Because when you invest with knowledge, you build the future you deserve.', italics: true, alignment: 'center', fontSize: 11, margin: [0, 24, 0, 0] },
        ],
        styles: {
          table: {
            bold: true,
            ...
            columns: [
              {
                table: {
                  ...
                  body: [
                    [
                      {
                        text: 'Personal Investment Credit — German Payment Schedule',
                        alignment: 'center',
                        fillColor: '#DA2128',
                        color: 'white',
                        bold: true,
